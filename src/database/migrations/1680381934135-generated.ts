...
export class generated1680381934135 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "species_file_images_file_image" ("film_id" integer NOT NULL, "file_image_id" integer NOT NULL, CONSTRAINT "PK_3016622a24801d2baf3af42ec41" PRIMARY KEY ("film_id", "file_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "planet_public_images_public_image" ("film_id" integer NOT NULL, "public_image_id" integer NOT NULL, CONSTRAINT "PK_0d0041e469fd7b79ba14152e5ff" PRIMARY KEY ("film_id", "public_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "planet_file_images_file_image" ("film_id" integer NOT NULL, "file_image_id" integer NOT NULL, CONSTRAINT "PK_415d6ba8324a0715f99f737112d" PRIMARY KEY ("film_id", "file_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "starships_public_images_public_image" ("film_id" integer NOT NULL, "public_image_id" integer NOT NULL, CONSTRAINT "PK_927d9baa8848907a3f22c3eb136" PRIMARY KEY ("film_id", "public_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "starships_file_images_file_image" ("film_id" integer NOT NULL, "file_image_id" integer NOT NULL, CONSTRAINT "PK_734040610b57cd4ba1c337187ab" PRIMARY KEY ("film_id", "file_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vehicles_public_images_public_image" ("film_id" integer NOT NULL, "public_image_id" integer NOT NULL, CONSTRAINT "PK_679ddbaef76b0234f7498832fd0" PRIMARY KEY ("film_id", "public_image_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "films_public_images_public_image" ("film_id" integer NOT NULL, "public_image_id" integer NOT NULL, CONSTRAINT "PK_cbf1ed1947d880a7d98755708a4" PRIMARY KEY ("film_id", "public_image_id"))`);
